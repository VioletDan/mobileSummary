...
function importBase() {
	...
	base.init = function(options) {
		var defaults = {dir:'portrait', wd:1206, ht:750, scale:'cover', lock:true,test:true};//dir：锁定方向、wd：设计宽度、ht：设计高度、scale：缩放模式(cover,contain,full)、lock：假横屏锁定
		...
		if(this.test){
			document.write('<div class="testTip">本次活动中，抽奖一律作废</div>');
		}
	} //end func
